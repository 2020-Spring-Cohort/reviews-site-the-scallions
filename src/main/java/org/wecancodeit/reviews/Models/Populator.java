...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception{
        categoryStorage.store(new Category("Red","This revolting merlot is full-bodied and dry, with hints of dragon blood and unicorn flesh and a sweet finish of nitrogen salts and vaporous aluminum chloride."));
//        categoryStorage.store(new Category("Red","This cannibal chianti graces the palate with the taste of fava beans and liver."));
...
//        categoryStorage.store(new Category("Red","This premium Shiraz is manufactured in Narnia, with a strong flavor of freshly-cut grass and just a hint of manticore teeth on the finish."));
        categoryStorage.store(new Category("White","This shimmering chardonnay has a long history of use in the eldritch rituals of Yog-Sothoth"));
//        categoryStorage.store(new Category("White","This riesling was fermented from the finest of Sicilian grapes mixed with Satan's tears."));
